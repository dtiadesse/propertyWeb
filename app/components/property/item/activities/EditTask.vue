<template>
  {{ model }}
  <UiItemExpandableSection label="Task Information">
    ...
    <div class="slds-grid slds-wrap slds-p-horizontal_small">
      <div class="slds-col slds-size_12-of-12">
        <div class="slds-checkbox">
          <input type="checkbox" name="options" :id="'task-checkbox-id-101'" :value="true"
            @change="updateModel($event, 'reminder')" :checked="model.reminder" />
